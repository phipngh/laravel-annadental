                        ...
                        <div class="card-body p-4">
                            ...
                            <form method="POST" action="{{ route('password.update') }}">
                               @csrf
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus placeholder="youremail@example.com">
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row mt-4">
                                <div class="col-sm-12 text-center">
                                    <p class="text-muted mb-0">Everything seems ok ? Back to<a href="{{route('login')}}" class="text-dark ml-1"><b>Sign In</b></a></p>
                                </div>
                            </div>
