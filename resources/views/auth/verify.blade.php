...
{{--                        @csrf--}}
{{--                        <button type="submit" class="btn btn-link p-0 m-0 align-baseline">{{ __('click here to request anothers') }}</button>.--}}
{{--                    </form>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card bg-pattern">
                        ...
                        <div class="card-body p-4">
                            ...
                            <h5 class="text-uppercase text-center font-bold mt-4">Email Verification</h5>
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-muted font-14 mt-2"> Before proceeding, please check your email for a verification link. </p>

                                <form class="d-inline" method="POST" action="{{ route('verification.resend') }}">
                                    @csrf
                                    <p>If you did not receive the email, <button type="submit" class="btn btn-link p-0 m-0 align-baseline">{{ __('click here to request anothers') }}</button></p>
                                </form>

                                <a href="{{route('user.index')}}" class="btn btn-md btn-block btn-gradient waves-effect waves-light mt-3">Back to Home</a>
